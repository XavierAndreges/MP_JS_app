...
try
	{
		...
		*/
        ...
        //setPrivateListItemWithTable ($PDOMySQL, "Loisirs");
        //setPrivateListItemWithTable ($PDOMySQL, "Sortir");
        
        setPrivateListItemWithTable ($PDOMySQL, "Shopping");
       ...
       setPrivateListItemWithTable ($PDOMySQL, "SitesNaturels");
        ...
        setPrivateListItemWithTable ($PDOMySQL, "Circuits");
        

        setPrivateListItemWithTable ($PDOMySQL, "Restos");
        
        
        setPrivateListItemWithTable ($PDOMySQL, "ExpositionsMusees");
        setPrivateListItemWithTable ($PDOMySQL, "Dormir");
...
function setPrivateListItemWithTable($PDOMySQL, $table)
{
    ...
    //$sql = "select * from ".$table." WHERE actif=3" ;
    
    //$sql = "select * from ".$table;
    
    if ($table == "BonsPlans")
        $sql = "select * from ".$table.$new." WHERE actif = 10";
    else
        $sql = "select * from ".$table.$new." WHERE actif != 0";
    ...
    for ($i = 0;  $i < count($itemArray);  $i++)
    {
        ...
        $sqlPicture = "select name from Pictures$new where idRepName='".$itemArray[$i]['idRepName']."'";
