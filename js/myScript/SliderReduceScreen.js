function MyReduceScreenSlider(divName, nameSlider, sliderSize, nameFullSlider)
{
	var self = this;
	...
	this.init = function (){
		...
		var myCssText  =
		'#' + divName + '_slider {width:' + sliderSize + 'px; height:100px; overflow: hidden; background-color: #2E2A2A; display: inline-block; text-align: left;}' +
		'#' + divName + '_thumbnails {width:600%; height: 100px; text-align:left; display:inline-block;}' +
		'#' + divName + '_thumbCenterBlock {display: inline-block; position:relative; width:200px; height:100px; text-align:center; overflow: hidden;}' +
		'#' + divName + '_imgThumbnailsH { width: 200px; }' +
		'#' + divName + '_imgThumbnailsV {height: 100px;}' +
		'#' + divName + ' {width:100%; min-width: 0px; height: 100px; background-color:#2E2A2A; clear: both;}'+
